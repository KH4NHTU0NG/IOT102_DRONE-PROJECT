...
*   *Hạn chế*: Giao thức loose coupling này xem như sensor và GPS đồng bộ tại thời điểm lưu. Tuy nhiên do lệch pha chu kỳ đọc cảm biến (\(2.0\text{ s}\)) với main loop (\(1.0\text{ s}\)), dữ liệu tích hợp có thể có sai lệch nhỏ khi di chuyển nhanh.
