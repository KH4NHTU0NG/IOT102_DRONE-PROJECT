...
> **Đọc kỹ phần này trước khi bắt đầu!**
...
> Bước này mất **15–30 phút** để clone và build lần đầu. Đừng đóng Terminal!
...
> **Mở tab Terminal MỚI** (`Cmd + T`) — KHÔNG dùng chung tab với bước khác!
...
>
> **KHÔNG đóng Tab này** trong suốt quá trình dùng hệ thống!
...
> **KHÔNG đóng Tab này** — đây là cầu nối dữ liệu chính!
